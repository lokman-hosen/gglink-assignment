    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{route('users.login')}}" class="nav-link {{\Illuminate\Support\Facades\Request::is('login') ? 'active' : ''}}">Login</a>
                </li>
                <li class="nav-item">
...
{{--<footer>
    <div class="bg-secondary"><p class="text-center">this is footer</p></div>
</footer>--}}
